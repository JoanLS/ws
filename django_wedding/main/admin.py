...
class GuestAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'code', 'coming_private_ceremony', 'coming_public_ceremony')
    list_filter = ('coming_private_ceremony', )
...
class GuestCodeAdmin(admin.ModelAdmin):
    inlines = (GuestAdminInline, GuestChildrenAdminInline, GuestCommentsInlineAdmin)


class GuestCommentsAdmin(admin.ModelAdmin):
    list_display = ('code', 'dietary_restrictions', 'music_request', 'comments')
